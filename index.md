...
Philajaeron is a high fantasy world, inhabited by mostly non-magical creatures. 
...
## Things to add later:
 - geography (start small)
 - describe native creatures (what, where)
 - socio-economic background of the three kingdoms
 - cultural beliefs and practices
 - how climate effects all the above
 - explain the current status of science, tecnology, magic
    - magic:
    - origin:
    - uses:
    - integration into the world
    - magical teachers, learning time, ... 
 - infrastructure
 - history (natural, celestial, war) from beginning to now
...
## Islands
 - [Farntry-Isle](/#!src/farntry-isle.md)
 - [Kházdûral Havn]
